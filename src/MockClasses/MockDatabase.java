...
public class MockDatabase {
    ...
    private MockDatabase(){
        ...
        room.addBooking(new Booking(LocalDate.of(2022, 1, 8), LocalDate.of(2022, 1, 9), new Guest("Test", "Test", "test@test.is"), room));
        room.setHotel(hotel);
        hotel.addRoom(room);
        hotels.add(hotel);
        ...
        room.addAvailability(new LocalDate[]{LocalDate.of(2022, 10, 10), LocalDate.of(2022, 11, 15)});
        room.addBooking(new Booking(LocalDate.of(2022, 6, 8), LocalDate.of(2022, 8, 10), new Guest("Jon", "Test Street", "jon@jonsson.is"), room));
        room.addBooking(new Booking(LocalDate.of(2022, 8, 11), LocalDate.of(2022, 10, 9), new Guest("Sigurdur", "Test Street 2", "sig@sig.is"), room));
        room.setHotel(hotel);
        hotel.addRoom(room);
        hotels.add(hotel);
        ...
        room.addBooking(new Booking(LocalDate.of(2022, 8, 11), LocalDate.of(2022, 10, 10), new Guest("Andy", "Test Street 2", "ukman@ukman.co.uk"), room));
        room.setHotel(hotel);
        ...
        room.addBooking(new Booking(LocalDate.of(2022, 8, 11), LocalDate.of(2022, 10, 9), new Guest("Mary", "Test Street 5", "marymary@times.co.uk"), room));
        room.setHotel(hotel);
        hotel.addRoom(room);
        hotels.add(hotel);
        ...
        room.addBooking(new Booking(LocalDate.of(2022, 8, 11), LocalDate.of(2022, 10, 9), new Guest("Klaus", "Test Street 2", "ukman@ukman.co.uk"), room));
        room.setHotel(hotel);
        room = new Room("204", 2, false, false,  122.0, null);
        room.addAvailability(new LocalDate[]{LocalDate.of(2022, 1, 2), LocalDate.of(2022, 6, 7)});
        room.addAvailability(new LocalDate[]{LocalDate.of(2022, 10, 11), LocalDate.of(2022, 11, 15)});
        room.addAvailability(new LocalDate[]{LocalDate.of(2022, 11, 18), LocalDate.of(2022, 12, 15)});
        ...
        room.addBooking(new Booking(LocalDate.of(2022, 8, 11), LocalDate.of(2022, 10, 9), new Guest("Amerikaner", "Test Street 2", "amerikaner@amerikaner.com"), room));
        room.addBooking(new Booking(LocalDate.of(2022, 11, 16), LocalDate.of(2022, 11, 17), new Guest("Testing", "Test Street 2", "amerikaner@test.com"), room));
        room.setHotel(hotel);
        hotel.addRoom(room);
        hotels.add(hotel);
        ...
        room.addBooking(new Booking(LocalDate.of(2022, 8, 11), LocalDate.of(2022, 10, 9), new Guest("Norskur", "Test Street 2", "norks@norks.no"), room));
        room.setHotel(hotel);
        room = new Room("204", 2, false, false,  122.0, null);
        room.addAvailability(new LocalDate[]{LocalDate.of(2022, 1, 2), LocalDate.of(2022, 6, 7)});
        room.addAvailability(new LocalDate[]{LocalDate.of(2022, 10, 11), LocalDate.of(2022, 11, 15)});
        room.addBooking(new Booking(LocalDate.of(2022, 6, 8), LocalDate.of(2022, 8, 10), new Guest("Geir", "Test Street", "geir@jonsson.is"), room));
        room.addBooking(new Booking(LocalDate.of(2022, 8, 11), LocalDate.of(2022, 10, 9), new Guest("Danskur", "Test Street 2", "danskur@danskur.dk"), room));
        room.setHotel(hotel);
        hotel.addRoom(room);
        hotels.add(hotel);
    }
